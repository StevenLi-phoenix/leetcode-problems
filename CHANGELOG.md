...
- Solved 498 (Diagonal Traverse, Medium) on 2026-07-07 — 对角线分组遍历，偶数对角线反向.
  Files: problems/498.diagonal-traverse.cpp Notable: 1397 数位DP+KMP自动机, 3915 值域线段树+延迟插入, 3241 re-rooting DP, 1931 列状态DP, 312 区间DP, 975 单调栈, 2968 中位数滑窗.
